...
export default {
  ...
  mounted() {
    this.my_nodes = [{name: "状态1", jointAngle: [1], position: "left"},
      {name: "状态2", jointAngle: [1, 2, 3, 4], position: "left"},]
    this.my_edges = [{source: 0, target: 1, parameter: ['belongs'], planningMethod: '1'}]
